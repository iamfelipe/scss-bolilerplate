...
class DualImageLayout {
    ...
    layout() {
        ...
        for (let i = 0; i < this.totalSlices; i += 1) {
            ...
            let y1 = 0;
            let y2 = "100%";
            const clippath = this.options.orientation === "vertical"
            ...
            this.DOM.slices = {
                ...
                get even() {
                    return this.all.filter(slice => slice.classList.contains("slice--even"));
                },
                get odd() {
                    return this.all.filter(slice => slice.classList.contains("slice--odd"));
                }
            };
...
exports.DualImageLayout = DualImageLayout;
